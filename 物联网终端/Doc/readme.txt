...
(1)ESP8266 上报属性（湿度、温度、光照强度、板载 LED 状态）到 MQTT 服务器
(2)ESP8266 接收 MQTT 服务器下发的指令，控制板载 LED 的亮灭
...
(3)LIGHT_PERCENTAGE_THRESHOLD：光照强度阈值

2. Wi-Fi 和 MQTT 服务器（APP\esp8266\app_esp8266.c）
(1)ESP8266_AP_SSID：Wi-Fi 名称
(2)ESP8266_AP_PWD：Wi-Fi 密码
(3)CONNECT_ID：连接ID
(4)MQTT_SERVER_IP：MQTT 服务器 IP
(5)MQTT_SERVER_PORT：MQTT 服务器端口
(6)DEVICE_NAME：设备名称
(7)PRODUCT_ID：产品ID
(8)TOKEN：token
(9)MQTT_TOPIC_POST：设备上报属性的主题
(10)MQTT_TOPIC_POST_REPLY：MQTT 服务器回复上报结果的主题
(11)MQTT_TOPIC_SET：MQTT 服务器下发指令的主题
(12)MQTT_TOPIC_SET_REPLY：设备回复指令执行结果的主题
